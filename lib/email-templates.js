...
export function welcomeEmail({ displayName, appUrl = APP_URL, preferencesUrl }) {
  ...
  return {
    ...
    html: templateHtml({
      ...
      greeting: `Hi ${name},`,
      body: [
        paragraph('Your account is confirmed. You can now create or join a shared dashboard, plan dates, track tasks, save recipes, and keep your watchlist together.'),
    ...
    text: templateText({
      ...
      lines: [
        ...
        'You can now create or join a shared dashboard, plan dates, track tasks, save recipes, and keep your watchlist together.',
