...
const templateHtml = ({ preheader, heading, greeting, body, ctaLabel, ctaUrl, preferencesUrl }) => {
  ...
  return `
    ...
    <html>
      ...
      <body style="margin:0;background:#FFF8F2;color:#000000;font-family:Manrope,Arial,sans-serif">
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:560px;background:#FFFFFF;border:1px solid #F1D9CF;border-radius:18px;overflow:hidden">
                ...
                <tr>
                  <td style="padding:30px 28px 8px">
                    <h1 style="margin:0 0 16px;font-family:Epilogue,Arial,sans-serif;font-size:26px;line-height:1.2;color:#000000">${escapeHtml(heading)}</h1>
                    <p style="margin:0 0 16px;font-size:16px;line-height:1.6;color:#000000">${greeting}</p>
                    ${body}
                    ${ctaLabel && ctaUrl ? `
...
const paragraph = (value) =>
  `<p style="margin:0 0 16px;font-size:16px;line-height:1.6;color:#000000">${value}</p>`;
...
export function welcomeEmail({ displayName, appUrl = APP_URL, preferencesUrl }) {
  ...
  return {
    ...
    html: templateHtml({
      ...
      greeting: `Hi ${name},`,
      body: [
        paragraph('Your account is confirmed. You can now create or join a shared dashboard, plan dates, track tasks, save recipes, and keep your entertainment together.'),
    ...
    text: templateText({
      ...
      lines: [
        ...
        'You can now create or join a shared dashboard, plan dates, track tasks, save recipes, and keep your entertainment together.',
