...
## Prompt 1: Configure The App For `coupleplanner.app`

I bought the domain `coupleplanner.app`. Update the web app so production links consistently use this public domain.
...
- Ensure the app works correctly when deployed at `https://coupleplanner.app`.
